...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="panel">
		...
		<xsl:call-template name="smartcsw"/>
	</xsl:template>
	...
	<xsl:template name="smartcsw">
		<script type="text/javascript" language="JavaScript1.2">
			function updateContact(id) {
				...
				$('smartcsw.individualName').value      = records['record_'+id].name +' '+ records['record_'+id].surname;
				$('smartcsw.positionName').value        = records['record_'+id].profile;
				$('smartcsw.administrativeArea').value  = records['record_'+id].state;
				$('smartcsw.postalCode').value          = records['record_'+id].zip;
				$('smartcsw.country').value             = records['record_'+id].country;
				$('smartcsw.deliveryPoint').value       = records['record_'+id].address;
				$('smartcsw.city').value                = records['record_'+id].city;
				$('smartcsw.email').value               = records['record_'+id].email ;
				$('smartcsw.role').value                = records['record_'+id].kind;
				$('smartcsw.contactInstructions').value = records['record_'+id].organisation;
			}
		</script>

		<h1 align="left"><xsl:value-of select="/root/gui/config/smartcsw"/></h1>

		<div align="left" style="{$style}">
            <table>
            	<tr>
					<td class="padded" width="{$width}"><xsl:value-of select="/root/gui/config/enable"/></td>
					<td class="padded"><input id="smartcsw.enable" class="content" type="checkbox"/></td>
				</tr>
            	<tr>
            		<td class="padded"><xsl:value-of select="/root/gui/config/contactId"/></td>
            		<td class="padded">
            			<select name="smartcsw.contactId" id="smartcsw.contactId" onchange="javascript:updateContact(this.value)">
            				<option value="-1"></option>
            				<xsl:for-each select="/root/gui/users/record">
            					<xsl:sort select="username"/>
            					<option>
            	...
            	<tr>
            		<td class="padded"><xsl:value-of select="/root/gui/config/title"/></td>
            		<td class="padded"><input id="smartcsw.title" class="content" type="text" value="" size="40"/></td>
            	</tr>
            	<tr>
            		<td class="padded"><xsl:value-of select="/root/gui/config/abstract"/></td>
            		<td class="padded"><input id="smartcsw.abstract" class="content" type="text" value="" size="40"/></td>
            	</tr>
            	<tr>
            		<td class="padded"><xsl:value-of select="/root/gui/config/fees"/></td>
            		<td class="padded"><input id="smartcsw.fees" class="content" type="text" value="" size="40"/></td>
            	</tr>
            	<tr>
            		<td class="padded"><xsl:value-of select="/root/gui/config/accessConstraints"/></td>
            		<td class="padded"><input id="smartcsw.accessConstraints" class="content" type="text" value="" size="40"/></td>
            	</tr>
            	<tr>
            		<td class="padded" colspan="2">
            			<input id="smartcsw.individualName" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.positionName" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.voice" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.facsimile" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.deliveryPoint" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.city" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.administrativeArea" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.postalCode" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.country" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.email" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.hoursOfService" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.contactInstructions" class="content" type="hidden" value="" size="20"/>
            			<input id="smartcsw.role" class="content" type="hidden" value="" size="20"/>
            		</td>
            	</tr>
                <tr>
                    <td class="padded"><xsl:value-of select="/root/gui/config/smartcswMetadataPublic"/></td>
                    <td class="padded"><input id="smartcsw.metadataPublic" class="content" type="checkbox" value=""/></td>
                </tr>
            </table>
        </div>
	</xsl:template>
