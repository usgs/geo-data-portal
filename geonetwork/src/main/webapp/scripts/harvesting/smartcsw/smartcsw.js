...
ker.include('harvesting/smartcsw/model.js');
ker.include('harvesting/smartcsw/view.js');

var smartcsw = new Object();

//=====================================================================================

function SmartCsw(xmlLoader)
{
	//--- call super constructor
	Harvester.call(this);
	
	var loader= xmlLoader;
	var model = new smartcsw.Model(loader);
	var view  = new smartcsw.View(loader);
...
this.getType      = function() { return "smartcsw"; }
this.getLabel     = function() { return loader.eval("info[@type='smartcsw']/long"); }
this.getEditPanel = function() { return "smartcsw.editPanel"; }
