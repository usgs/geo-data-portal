...
public class Aligner
{
	...
	public Aligner(Logger log, ServiceContext sc, Dbms dbms, CswServer server, SmartCswParams params) throws OperationAbortedEx
	{
		this.log        = log;
		this.context    = sc;
		this.dbms       = dbms;
	...
	public SmartCswResult align(Set<RecordInfo> records) throws Exception
	{
