...
import org.fao.geonet.kernel.harvest.harvester.csw.*;
...
//=============================================================================
public class SmartCswHarvester extends AbstractHarvester
{
	//--------------------------------------------------------------------------
	//---
	//--- Static init
	...
	public String getType() { return "smartcsw"; }
	...
	{
		params = new SmartCswParams(dataMan);
		params.create(node);
	}
	...
	{
		SmartCswParams copy = params.copy();
	...
	{
		SmartCswParams params = (SmartCswParams) p;
		...
		for (Search s : params.getSearches())
		{
			...
			settingMan.add(dbms, "id:"+searchID, "endpoint", s.endpoint);
		}
	}
	...
	private SmartCswResult result;
}

class SmartCswResult
{
