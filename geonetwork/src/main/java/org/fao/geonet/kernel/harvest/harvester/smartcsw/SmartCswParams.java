...
public class SmartCswParams extends AbstractParams
{
	//--------------------------------------------------------------------------
	//---
	//--- Constructor
	...
	public SmartCswParams(DataManager dm)
	{
		super(dm);
	}
	...
	public SmartCswParams copy()
	{
		SmartCswParams copy = new SmartCswParams(dm);
		copyTo(copy);
