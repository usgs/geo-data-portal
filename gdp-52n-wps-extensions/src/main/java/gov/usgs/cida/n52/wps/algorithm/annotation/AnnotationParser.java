...
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.InputFieldBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.InputMethodBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.OutputBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.OutputFieldBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.OutputMethodBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.ProcessMethodBinding;
import gov.usgs.cida.n52.wps.algorithm.descriptor.BoundDescriptor;
...
import gov.usgs.cida.n52.wps.algorithm.util.ClassUtil;
...
public abstract class AnnotationParser<A extends Annotation, M extends AccessibleObject & Member, B extends AnnotationBinding<M>> {
    ...
    public static class ProcessAnnotationParser extends AnnotationParser<Process, Method, ProcessMethodBinding> {

        @Override
        public ProcessMethodBinding parse(Process annotation, Method member) {
            ProcessMethodBinding annotationBinding = new ProcessMethodBinding(member);
            return annotationBinding.validate() ? annotationBinding : null;
        }

        @Override
        public Class<? extends Process> getSupportedAnnotation() {
