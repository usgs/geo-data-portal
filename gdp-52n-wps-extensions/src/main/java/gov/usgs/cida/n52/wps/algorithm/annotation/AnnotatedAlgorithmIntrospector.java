package gov.usgs.cida.n52.wps.algorithm.annotation;
...
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.InputBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.OutputBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationBinding.ProcessMethodBinding;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.ComplexDataInputFieldAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.ComplexDataInputMethodAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.ComplexDataOutputFieldAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.ComplexDataOutputMethodAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.InputAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.LiteralDataInputFieldAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.LiteralDataInputMethodAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.LiteralDataOutputFieldAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.LiteralDataOutputMethodAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.OutputAnnotationParser;
import gov.usgs.cida.n52.wps.algorithm.annotation.AnnotationParser.ProcessAnnotationParser;
...
public class AnnotatedAlgorithmIntrospector {
    ...
    private final static ProcessAnnotationParser PROCESS_PARSER;
    ...
    static {
        ...
        PROCESS_PARSER = new ProcessAnnotationParser();
    }
    ...
    private ProcessMethodBinding processMethodBinding;
    ...
    private void parseClass() {
        ...
        for (Method method : algorithmClass.getDeclaredMethods()) {
            if (method.isAnnotationPresent(PROCESS_PARSER.getSupportedAnnotation())) {
                ProcessMethodBinding processMethodBinding = PROCESS_PARSER.parse(method);
                if (processMethodBinding != null) {
                    if (this.processMethodBinding != null) {
                        ...
                        throw new RuntimeException("Multiple process method bindings encountered for class " + getClass().getCanonicalName());
                    }
                    this.processMethodBinding = processMethodBinding;
                }
            }
        }
    ...
    public ProcessMethodBinding getProcessMethodBinding() {
        return processMethodBinding;
    }
