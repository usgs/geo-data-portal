...
public class TZYXGridCellVisitorTest {

    private GridCellVisitorMock gcvm = null;
    private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TZYXGridCellVisitorTest.class);
    ...
    public void testVisitorMockProcessCount() throws IOException {
        int cells = T_SIZE * Z_SIZE * Y_SIZE * X_SIZE;
