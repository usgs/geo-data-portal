...
public class ProcessServlet extends HttpServlet {
	...
	private FileLocationBean populateSummary(HttpServletRequest request) throws IOException, InvalidRangeException, FactoryException, TransformException, org.opengis.coverage.grid.InvalidRangeException, SchemaException {
	    ...
	    if (lat != null && lon != null) {
	    	...
	    	featureCollection = NHDService.getGeometry(lon, lat, userDirectory, shapefilePath);
        ...
        if ("WCS".equals(dataSetInterface)) {
            ...
            try {
                ...
                HttpURLConnection httpConnection =
                    HTTPUtils.openHttpConnection(new URL(getCoverageRequest), "GET");

                coverageIStream =
                    HTTPUtils.getHttpConnectionInputStream(httpConnection);

                Map<String, List<String>> headerFields =
                    HTTPUtils.getHttpConnectionHeaderFields(httpConnection);
