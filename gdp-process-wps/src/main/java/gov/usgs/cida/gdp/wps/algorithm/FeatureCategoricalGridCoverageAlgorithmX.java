 ...
 * @author tkunicki
 */
public class FeatureCategoricalGridCoverageAlgorithmX extends AbstractSelfDescribingAlgorithm {
    ...
    static {
        ALGORITHM_DESCRIPTOR = AlgorithmDescriptor.builder(FeatureCategoricalGridCoverageAlgorithmX.class).
                version("1.0.0").
                storeSupported(true).
    ...
    public FeatureCategoricalGridCoverageAlgorithmX() {
            super();
    }
