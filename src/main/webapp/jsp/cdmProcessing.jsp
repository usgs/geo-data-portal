...
<c:set var="processShapeFiles"	value="/Router?location=geotoolsProcessing&action=processFiles&method=geoTools&function=summarize" />
...
<c:url var="cdmProcessing" value="/Router/cdmProcessing.jsp"/>
...
<head>
	...
	<title>Processing Using NetCDF/CDM/OpenDAP</title>
</head>
<body>
${head}
