			...
			<div id="header">
            	<div id="banner-area">
					...
					<div id="usgsPrintCommHeader" class="print-only">
						...
						<p class="hide">
							The section 'Web Page Hardcopy' is only visible when printed.  
							Ignore if viewing with style sheets turned off
						</p>
            	...
            	<h2 id="site-title">Geodata Portal</h2>
			</div><!-- /header -->
