...
public class THREDDSInfoBean implements Serializable {
    ...
    public List<String> getDatasetUrlList() {
        if (this.datasetUrlList == null) {
            this.datasetUrlList = new ArrayList<String>();
        }
    ...
    public List<String> getDatasetNameList() {
        if (this.datasetNameList == null) {
            this.datasetNameList = new ArrayList<String>();
        }
    ...
    public List<String> getDatasetGridItems() {
        if (this.datasetGridTimes == null) {
            this.datasetGridTimes = new ArrayList<String>();
        }
